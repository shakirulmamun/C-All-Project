...
namespace Multitasking
{
    class Program
    {
        ...
        private static async void SolveTheMath1(int firstInt, int secondtInt)
        {
            int result = await Task.FromResult(Sub(firstInt, secondtInt));
            await Task.Delay(1000);
            Console.WriteLine("Substruction = " + result.ToString());
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=====================================\n");
            SolveTheMath1(firstInt, secondtInt); //Creating a Task using FromResult Method.
